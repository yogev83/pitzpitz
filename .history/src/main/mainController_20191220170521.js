...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.showBirthdate.bind(this, 800, 600), 3100);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3300);
    renderer.scheduleTask(this.showBirthdate.bind(this, 200, 200), 3500);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3700);
