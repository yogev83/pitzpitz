...
class PuzzleStructure extends Structure {
  ...
  getOnWrongDroppedCallback(wrong) {
    return (x, y) => {
  ...
  getRandomLocation(puzzleData) {
    let x = Utils.getRandomIntFromRanges([
      [PuzzleStructure.bounds.MIN_X, PuzzleStructure.bounds.MID_X_LEFT],
      [PuzzleStructure.bounds.MID_X_RIGHT, PuzzleStructure.bounds.MAX_X]
    ]);
