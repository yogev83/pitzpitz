    ...
    this.right = new Part(
      ...
      (x, y) => {
        if (this.puzzle.trySolving(x, y)) {
          console.warn(this.right.view.x);
          console.warn(this.right.view.options.width);
          console.warn(this.right.view.options.width / 2);
          console.warn(this.right.view.x + this.right.view.options.width / 2);
          this.onSolveStart(
