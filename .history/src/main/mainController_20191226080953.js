...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.showBirthdate.bind(this, 700, 500), 2900);
  ...
  showBirthdate(x, y) {
    ...
    this.birthdate.view.animateProperty("width", 50, 200, {
      onComplete: () => {
        this.birthdate.view.setProperty("width", width);
      }
    });
    this.birthdate.view.animateProperty("height", 150, 200, {
      onComplete: () => {
