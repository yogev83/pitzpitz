...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.showBirthdate.bind(this, 800, 600), 3050);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3250);
    renderer.scheduleTask(this.showBirthdate.bind(this, 200, 200), 3450);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3650);
