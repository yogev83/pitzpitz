...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.hideCanvas.bind(this), 5200);
    renderer.scheduleTask(this.showBirthdate.bind(this), 8400);
    renderer.scheduleTask(this.hideCanvas.bind(this), 8600);
  ...
  showBirthdate() {
    this.showCanvas();
    this.birthdate.view.animatePropertyTo("opacity", 1, 500);
    this.birthdate.view.animatePropertyTo("sizw", 130, 500);
  }
