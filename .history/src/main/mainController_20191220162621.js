...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.showCanvas.bind(this), 1000);
    renderer.scheduleTask(this.hideCanvas.bind(this), 1250);
    renderer.scheduleTask(this.showCanvas.bind(this), 1500);
    renderer.scheduleTask(this.hideCanvas.bind(this), 1750);
