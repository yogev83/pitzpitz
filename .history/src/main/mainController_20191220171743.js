...
class MainController {
  ...
  initCanvas() {
    ...
    this.ready.setView(new Renderable(600, 0, { imageName: "ready.png" }));
  }
  ...
  getReady() {
    this.birthdate.view.hide();
    this.ready.view.show();
    this.showCanvas();
    this.ready.view.animateProperty("y", 400, 500);
    //this.ready.view.show();
    //this.ready.view.animateProperty("y", 800);
  }

  startGame() {
    this.ready.view.animateProperty("y", 400, 1200, {
      onComplete: () => {
        this.ready.destroy();
      }
    });
