...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.canvasView.show, 1000);
    renderer.scheduleTask(this.canvasView.hide, 1250);
    renderer.scheduleTask(this.canvasView.show, 1500);
    renderer.scheduleTask(this.canvasView.hide, 1750);
