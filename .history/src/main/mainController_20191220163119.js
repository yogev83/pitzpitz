...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.hideCanvas.bind(this), 1150);
    renderer.scheduleTask(this.showCanvas.bind(this), 1300);
    renderer.scheduleTask(this.hideCanvas.bind(this), 1450);
