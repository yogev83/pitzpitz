...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.showBirthdate.bind(this, 800, 500), 2900);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3100);
    renderer.scheduleTask(this.showBirthdate.bind(this, 500, 400), 3300);
  ...
  showBirthdate(x, y) {
    ...
    this.birthdate.view.animatePropertyTo("width", 115, 200, {
      onComplete: () => {
        this.birthdate.view.setProperty("width", width);
      }
    });
    this.birthdate.view.animatePropertyTo("height", 150, 200, {
      onComplete: () => {
