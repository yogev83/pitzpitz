...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.canvasView.hide.bind(this), 1250);
    renderer.scheduleTask(this.canvasView.show.bind(this), 1500);
    renderer.scheduleTask(this.canvasView.hide.bind(this), 1750);
