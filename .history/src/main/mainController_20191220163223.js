...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.hideCanvas.bind(this), 3150);
    renderer.scheduleTask(this.showCanvas.bind(this), 3300);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3450);
    renderer.scheduleTask(this.startGame.bind(this), 5000);
  }
