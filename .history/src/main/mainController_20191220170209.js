...
class MainController {
  ...
  intro() {
    ...
    renderer.scheduleTask(this.showBirthdate.bind(this, 300, 200), 3000);
    renderer.scheduleTask(this.hideCanvas.bind(this), 3200);
    renderer.scheduleTask(this.showBirthdate.bind(this, 800, 600), 3400);
  ...
  showBirthdate(x, y) {
    ...
    this.birthdate.view.animatePropertyTo("opacity", 200, 100);
    this.birthdate.view.animatePropertyTo("size", 200, 100, {
      onComplete: () => {
