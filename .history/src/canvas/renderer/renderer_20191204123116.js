...
class Renderer {
  ...
  createHitCanvas() {
    ...
    hitCtx = $("canvas#hitCanvas")[0].getContext("2d");
    hitCtx.canvas.width = this.ctx.canvas.width;
    hitCtx.canvas.height = this.ctx.canvas.height;

    console.warn(this.ctx.canvas.width, this.ctx.canvas.height);
