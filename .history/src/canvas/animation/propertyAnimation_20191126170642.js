...
class PropertyAnimation {
  ...
  getNewValue(currentDelta) {
    if (this.options.customFunction == "function") {
      console.warn("this.options.customFunction", this.options.customFunction);
      return this.options.customFunction(this.startTime, currentDelta);
    } else {
