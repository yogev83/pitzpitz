...
class Frameable extends Renderable {
  ...
  drawFrame(ctx, image, frame) {
    if (this.options.imageOffset) {
      ...
      ctx.drawImage(
        image,
        frame.frameX + this.options.imageOffset.x,
        frame.frameY + this.options.imageOffset.y,
        this.options.imageOffset.width,
        this.options.imageOffset.height,
        this.x,
        this.y,
        this.options.width,
        this.options.height
